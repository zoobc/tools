...
/** The BIP-39 English word list (2048 words), as the reference wallet generator uses it. */
export const BIP39_WORDS: readonly string[] = [
  ...
  "fun", "funny", "furnace", "fury", "future", "gadget", "gain", "galaxy", "gallery", "app", "gap", "garage", "garbage", "garden", "garlic", "garment",
