...
(`py/README.md`) and the Go module (`go/README.md`) are here too, minus `--encrypt`. The other
languages follow in the order of [ROADMAP.md](ROADMAP.md): Rust, Kotlin, Swift, PHP, Perl.

| Tool | C++ | TypeScript / JS | Python | Go | Rust | Kotlin | Swift | PHP | Perl |
|------|-----|-----------------|--------|----|------|--------|-------|-----|------|
| zbc-cli (all transactions) | done | done (58 types, generated from the spec) | done (58 types) | done (58 types) | next | planned | planned | planned | planned |
| one program per transaction | done (45) | n/a, one command | n/a, one command | done (45, generated) | next | n/a, one command | n/a | n/a, one command | n/a, one command |
| key and address generators | done | done (library and `zbc-cli`; no separate generator programs) | done (library) | done (library) | next | planned | planned | planned | planned |
| passes every vector in `spec/vectors` in CI | done | done | done | done | next | planned | planned | planned | planned |
