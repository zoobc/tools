...
int main(int argc, char* argv[]) {
    ToolConfig config;
    config.name = "ZooBC Token Transfer Tool";
    config.description = "Transfer a held token to a recipient.";
    config.tx_type = static_cast<uint32_t>(zoobc::TransactionType::TransferToken);
